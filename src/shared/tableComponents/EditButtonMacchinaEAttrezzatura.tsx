...
const EditButtonMacchinaEAttrezzatura: React.FC<EditButtonMacchinaEAttrezzaturaProps> = (
    {
        macchinaEAttrezzaturaTarget, setEditabile, setModifica
    }
) => {
        ...
        <>
            <div className="text-right">
                <label
                    ...
                    className="mr-4"
                    onClick={() => {
                        dispatch(setMacchinaEAttrezzaturaSelezionato(macchinaEAttrezzaturaTarget));
                        setEditabile(false);
                    }}
                >
                    apri
                ...
                >
                    <button
                        className="btn btn-link btn-xs hover:bg-sky-500"
                        onClick={() => {
                            const removeVar = dispatch(setMacchinaEAttrezzaturaSelezionato(macchinaEAttrezzaturaTarget));
...
export default EditButtonMacchinaEAttrezzatura